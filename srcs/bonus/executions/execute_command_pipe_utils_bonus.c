...
/*                                                                            */
/*                                                        :::      ::::::::   */
/*   execute_command_pipe_utils_bonus.c                 :+:      :+:    :+:   */
/*                                                    +:+ +:+         +:+     */
/*   By: sandriam <sandriam@student.42antananari    +#+  +:+       +#+        */
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2024/12/24 17:58:47 by sandriam          #+#    #+#             */
/*   Updated: 2024/12/27 09:00:09 by sandriam         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	if (is_builtin(cmd->tp_arg[i][0]->tp_val))
	{
		close_fd_heredoc_possible(cmd);
		execute_builtins_pipe(i, cmd->tp_arg[i][0]->tp_val, env, cmd);
		exit(set_st(-1));
	}
	else
	{
